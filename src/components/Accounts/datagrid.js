        ...
        e.items = [{
          ...
          onItemClick: function() {
            ...
            setEditColumnInfo({
              isOpened: true,
              isNew: false,
              isNegative: prevColumn.isNegative,
  ...
  const handleSaveColumn = async () => {
    if (editColumnInfo.isNew) {
      await createColumn({
        ...
        isNegative: editColumnInfo.isNegative
      })
  ...
  return (
    <React.Fragment>
      ...
      <Dialog maxWidth={'sm'} open={editColumnInfo.isOpened} onClose={handleCloseEditColumnDialog} aria-labelledby="form-dialog-title">
        ...
        <DialogContent style={{height: 260}}>
          <form noValidate autoComplete="off">
            <Grid container spacing={3}>
              ...
              <Grid item xs={12}>
              <FormControl className={classes.formControl}>
                  <InputLabel className={classes.textField} htmlFor="isNegative">Is negative</InputLabel>
                  <Select
                    className={classes.textField}
                    value={editColumnInfo.isNegative}
                    onChange={handleFormChange('isNegative')}
                    inputProps={{
                      name: 'isNegative',
                      id: 'isNegative',
                    }}
